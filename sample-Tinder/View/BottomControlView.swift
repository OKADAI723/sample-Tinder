...
//  sample-Tinder
//
//  Created by Yudai Fujioka on 2021/07/29.
//
...
final class BottomControlView: UIView {
    ...
    let view1 = BottomButtonView(frame: .zero, width: 50, imageName: "reload")
       let view2 = BottomButtonView(frame: .zero, width: 60, imageName: "list")
       let view3 = BottomButtonView(frame: .zero, width: 50, imageName: "bad")
